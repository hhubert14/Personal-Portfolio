...
const MonkeytypeUserData = () => {
    const [userData, setUserData] = useState<MonkeytypeUserDataType | null>(
        null
    )
    ...
    return (
        <div>
            ...
            {userData && (
                <div>
                    <h2>
                        <a href="https://monkeytype.com/profile/Hube">
                            {userData.data.name}
                        </a>
                    </h2>
                    <div className="flex flex-row">
                        ...
                        <div>
                            ...
                            <p>
                                {
                                    userData.data.allTimeLbs.time["15"][
                                        "english"
                                    ].rank
                                }
                                nd
                        ...
                        <div>
                            ...
                            <p>
                                {
                                    userData.data.allTimeLbs.time["60"][
                                        "english"
                                    ].rank
                                }
                                nd
                        ...
                        {times.map((time) => (
                            <div key={time} className="border mx-auto">
                                ...
                                <p>
                                    WPM:{" "}
                                    {
                                        userData.data.personalBests.time[
                                            time
                                        ][0].wpm
                                    }
                                </p>
                        ...
                        {words.map((word) => (
                            <div key={word} className="border mx-auto">
                                ...
                                <p>
                                    WPM:{" "}
                                    {
                                        userData.data.personalBests.words[
                                            word
                                        ][0].wpm
                                    }
                                </p>
